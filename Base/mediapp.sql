...
-- Generado: 2026-08-31 23:52
-- Servidor: MariaDB 10.4.28 (XAMPP)
--
-- Incluye las migraciones 001 y 002, cuentas de acceso de los 3
-- medicos originales, la correccion de datos de la cita 5, y el
-- hasheo (scrypt) de las 2 contrasenas que aun estaban en texto
-- plano (tete, admin). Ya no queda ninguna contrasena sin hashear
-- y el login ya no acepta texto plano como fallback.
-- =====================================================================
...
-- Dump completed on 2026-08-31 23:52:15
